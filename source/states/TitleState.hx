...
class TitleState extends MusicBeatState
{
	...
	var maidSkin:Bool = false;
	var unlockedFinal:Bool = false;
	var maidDiff:Bool = false;

	public static var bestScore:Int;
	public static var playSong:Bool = true;
	public static var coin:Int;
	public static var instCoin:Bool = true;

	var curWacky:Array<String> = [];

	var wackyImage:FlxSprite;
	public static var title:String = 'FNF X Maid Dragon';
	...
	override public function create():Void
	{
		...
		Lib.current.stage.window.title = title + ' - Title Menu';
		...
		trace(FlxG.save.data.maidSkin);

		maidSkin = FlxG.save.data.maidSkin;
		unlockedFinal = FlxG.save.data.unlockedFinal;
		maidDiff = FlxG.save.data.maidDiff;
		coin = FlxG.save.data.coin;
		bestScore = FlxG.save.data.bestScore;
		instCoin = FlxG.save.data.inCoin;
